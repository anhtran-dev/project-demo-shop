        ...
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title fl-left"><?php echo $product_cat['cat_title']; ?></h3> 
                </div>
                <?php
                if (!empty($list_product)) {
                    ?>
                    <p class="num-product">Có tất cả (<?php echo $num_product; ?>) sản phẩm hiện có trong hệ thống</p>
                ...
                <div class="section fl-right" id="paging-wp">
                    <div class="section-detail">
                        <?php echo get_paging($num_page, $page, "?mod=product&action=index&cat_id={$cat_id}") ?>
                    </div>
                </div>
            </div>
            <?php get_sidebar(); ?>
